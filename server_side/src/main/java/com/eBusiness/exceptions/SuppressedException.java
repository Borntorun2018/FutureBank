...
//import static com.newborn.functions.FunctionWithThrowable.castFunctionWithThrowable;
//import static com.newborn.exceptions.FunctionWithThrowable;
...
public class SuppressedException extends RuntimeException {
    ...
    public static <E extends Throwable> void throwUnsafelyAsUnchecked(Throwable exception) throws E {
        throw (E) exception;
    }
}
