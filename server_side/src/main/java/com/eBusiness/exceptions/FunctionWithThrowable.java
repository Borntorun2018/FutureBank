...
public interface FunctionWithThrowable<T, R, E extends Throwable> extends Function<T, R> {
     ...
     */
    public static <T, R, E extends Throwable> FunctionWithThrowable<T, R, E> castFunctionWithThrowable(final FunctionWithThrowable<T, R, E> functionwiththrowable) {
     ...
     * @return the cast interface
     */
    public static <T, R, E extends Throwable> Function<T, R> aFunctionThatUnsafelyThrowsUnchecked(final FunctionWithThrowable<T, R, E> functionwiththrowable) throws E {
     ...
     * @return the cast interface
     */
    public static <T, R, E extends Throwable> FunctionWithThrowable<T, R, E> asFunctionWithThrowable(final Function<T, R> function) {
